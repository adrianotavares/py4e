...
Actual data: http://py4e-data.dr-chuck.net/comments_2064021.json (Sum ends with 8)
...
The closest sample code that shows how to parse JSON and extract a list is json2.py. You might also want to 
look at xml3.py to see how to prompt for a URL and retrieve data from a URL.
...
# Retrieving http://py4e-data.dr-chuck.net/comments_2064021.json
# Retrieved 2745 characters
# Count: 50
# Sum: 2508 