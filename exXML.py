...
Actual data: http://py4e-data.dr-chuck.net/comments_2064020.xml (Sum ends with 24)
...
that shows how to parse XML is xml3.py.To make the code a little simpler, you can use an XPath selector string to look
...
# Retrieving http://py4e-data.dr-chuck.net/comments_2064020.xml
# Retrieved 4201 characters
# Count: 50
# Sum: 2724